...
function Navbot() {
    return (
        <>
            <div className="fixed-bottom boot">
                <Link to='/eproducts' className='custom-Link' >         
                ...
                <Link to='/bot' className='custom-Link'>
                    <img src={chatBot} alt='bot' width="30px" />
                </Link>
                <Link to='/learning' className='custom-Link'>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-journal-bookmark-fill" viewBox="0 0 16 16">
